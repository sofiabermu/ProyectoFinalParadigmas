...
/* package hermes-1.0.0 */
#ifndef VERSION_hermes
#define VERSION_hermes "1.0.0"
#endif /* VERSION_hermes */
#ifndef MIN_VERSION_hermes
#define MIN_VERSION_hermes(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_hermes */
...
#define CURRENT_COMPONENT_ID "hermes-1.0.0-inplace-hermes"
